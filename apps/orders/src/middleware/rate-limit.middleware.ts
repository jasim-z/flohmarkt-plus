...
export class RateLimitMiddleware implements NestMiddleware {
  ...
  private config: RateLimitConfig = { windowMs: 15 * 60 * 1000, maxRequests: 100, message: 'Too many requests' };
...
export const RATE_LIMITS = {
  GENERAL: { windowMs: 15 * 60 * 1000, maxRequests: 100, message: 'Too many requests' },
  CREATE: { windowMs: 60 * 1000, maxRequests: 10, message: 'Too many orders' },
};

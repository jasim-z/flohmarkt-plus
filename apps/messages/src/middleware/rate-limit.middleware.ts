...
export const RATE_LIMITS = {
  ...
  SEND: { windowMs: 60 * 1000, maxRequests: 30, message: 'Too many messages, slow down' },
  CONV_CREATE: { windowMs: 60 * 1000, maxRequests: 10, message: 'Too many conversation requests' },
};
